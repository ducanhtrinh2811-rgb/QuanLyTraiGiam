...
{
    public partial class KhenThuongDialog : Window
    {
        private readonly ApiService _apiService;
        private readonly KhenThuong? _editing;
        private readonly bool _isEdit;

        public KhenThuongDialog(ApiService apiService, KhenThuong? item = null)
        {
            InitializeComponent();
        ...
        private async System.Threading.Tasks.Task LoadData()
        {
            try
            {
                ...
                if (_isEdit && _editing != null)
                {
                    ...
                    dpNgay.SelectedDate = _editing.NgayKhenThuong;
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng chọn ngày khen thưởng!", "Cảnh báo");
                return;
            }
            ...
            try
            {
                var item = new KhenThuong
                {
                    ...
                    NgayKhenThuong = dpNgay.SelectedDate.Value,
                ...
                bool ok = _isEdit 
                    ? await _apiService.UpdateKhenThuongAsync(_editing!.Id, item) 
                    : await _apiService.CreateKhenThuongAsync(item);
